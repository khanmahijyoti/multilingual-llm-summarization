...
def main():
        ...
        with open(args.keys_file, "r", encoding="utf-8") as kf:
            for line in kf:
                ...
                if key.startswith("gsk_"):
                    key_pool.append({"type": "groq", "key": key, "model": "llama-3.3-70b-versatile"})
                elif key.startswith("sk-or-v1-"):
                    key_pool.append({"type": "openrouter", "key": key, "model": "meta-llama/llama-3.3-70b-instruct"})
    ...
    print(f"[+] Loaded {len(dataset)} dataset items for Llama 3.3 70B evaluation.")
    ...
    for item in tqdm(dataset, desc="Evaluating Llama 3.3 70B (Unified Keys)"):
        item_id = str(item['id'])
    ...
    print("\n==================================================")
    print(f"  Llama 3.3 70B Unified ROUGE Benchmark Results   ")
    print("==================================================")
